...
if(BShell==1)
{
  difference(){
   ...
   if(Side==1){
     // Cube that removes the left half translate is distance from origin, cube is size of the cube
     translate([-10, 0, -40]) cube([Length+20, Width/2, 150]);
   }
   if(Side==2){
    //Cube that removes the right half

    translate([-10, Width/2, -40]) cube([Length+20, Width/2+3, 150]);
   }
  }
  
  if(Side==2){
  // Create tabs that we use to join the two shells together
  
  difference(){
      translate([35, Width/2-50, -8]) cube([60,100,Thick*2]);
      translate([30, Width/2, -9]) cube([70, 55, Thick+1]);
  }
  difference(){
      translate([125, Width/2-50, -8]) cube([60,100,Thick*2]);
      translate([120, Width/2, -9]) cube([70, 55, Thick+1]);
  }
  difference(){
      translate([225, Width/2-50, -8]) cube([60,100,Thick*2]);
      translate([220, Width/2, -9]) cube([70, 55, Thick+1]);
  }
  }
}
...
// Insert Gluing tabs if this is the left half
  if(Side==2){
  difference(){
    translate([30, Width/2-50, 45]) cube([60,100,Thick*2]);
    translate([25, Width/2, 45+Thick]) cube([70, 55, Thick+1]);
  }

  difference(){
    translate([110, Width/2-50, 45]) cube([60,100,Thick*2]);
    translate([105, Width/2, 45+Thick]) cube([70, 55, Thick+1]);
  }
  rotate([0,8,0]){
      difference(){
        translate([185, Width/2-50, 69]) cube([15,100,Thick*2]);
        translate([180, Width/2, 69+Thick]) cube([25, 60, Thick+1]);
          }
  }
  }
  }
  ...
  rotate([0,8,0]){
      difference(){
        translate([302, Width/2-50, 64]) cube([5,100,Thick*2]);
        translate([300, Width/2, 64+Thick]) cube([10, 60, Thick+1]);
      }
  }
  }
  }
